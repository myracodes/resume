...
export class ProfessionalXpComponent {
    detailsCapco: IDetailsDialog = {
        ...
        paragraphs: [
            ...
            '📌 Développement des différentes applications : budget participatif, questionnaire, débat, etc.',
            ...
            "📌 Une optimisation clé : j'ai identifié et amélioré les tests flaky les plus fréquents, ce qui a permis de diminuer le taux d'échec, d'économiser des crédits CI, et de faire gagner du temps à l'équipe tech.",
