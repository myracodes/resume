...
export class ProfessionalXpComponent {
    detailsCapco: IDetailsDialog = {
        ...
        paragraphs: [
            ...
            "📌 Une optimisation clé : j'ai réorganisé les tests et corrigé \"flaky\" en priorisant ceux qui échouaient le plus fréquemment, ce qui a permis d'économiser des crédits CI, et de faire gagner du temps à l'équipe tech au quotidien (diminution de 33% de la durée moyenne d'une CI).",
            "📌 Une amélioration invisible mais impactante : en supprimant les sources de variabilité comme les images aléatoires et les dates dynamiques dans Storybook, j’ai réduit les faux positifs dans les tests visuels. Cela a permis de diminuer le besoin de validations manuelles.",
            "📌 Une tâche challengeante : le remplacement de l'outil de bundle du Design System, non-maintenu (TSDX) par Rollup.",
            "Recrutée au poste de développeuse front-end, je n'ai pas hésité à me porter volontaire pour des tâches back-end, avec l'assistance de l'IA, afin de réduire la charge de travail de l'équipe.",
        ],
        stack: [
            "ReactJS",
            "Typescript",
